...
socket_stream = ssc.socketTextStream("172.31.37.12", 5555) # Internal ip of  the tweepy streamer
...
def do_something(time, rdd):
    ...
    try:
        ...
        lineCountsDataFrame.coalesce(1).write.format("com.databricks.spark.csv").save("dirwithcsv", mode="append")
    except:
        pass
